...
namespace NS::RHI
{
    ...
    struct RHI_API RHIRenderTargetViewDesc
    {
        ...
        static RHIRenderTargetViewDesc Texture2DArray(IRHITexture* tex, uint32 mip, uint32 firstSlice, uint32 count = 1)
        {
            RHIRenderTargetViewDesc desc;
            desc.texture = tex;
    ...
    struct RHI_API RHIDSVClearValue
    {
        ...
        static RHIDSVClearValue DepthOnly(float d = 1.0f) { return RHIDSVClearValue(d, 0, ERHIClearDSFlags::Depth); }
