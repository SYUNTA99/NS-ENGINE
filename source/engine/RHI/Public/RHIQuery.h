...
namespace NS { namespace RHI {
    ...
    struct RHI_API RHIQueryHeapDesc
    {
        ...
        static RHIQueryHeapDesc PipelineStatistics(uint32 queryCount,
    ...
    public:
        ...
        /// 初期化
        bool Initialize(IRHIDevice* device, ERHIQueryType type, uint32 queriesPerFrame, uint32 numBufferedFrames = 3);
