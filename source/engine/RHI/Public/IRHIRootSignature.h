...
namespace NS
{
    namespace RHI
    {
        ...
        struct RHI_API RHIRootParameter
        {
            ...
            /// デフォルトコンストラクタ（unionの非自明メンバー対応）
            RHIRootParameter() : descriptorTable{nullptr, 0} {}
        ...
        {
        protected:
            IRHIRootSignature() : IRHIResource(ERHIResourceType::RootSignature) {}
        ...
        public:
            ...
            {
                return AddParameter(
                    RHIRootParameter::Constants(shaderRegister, num32BitValues, registerSpace, visibility));
            }
