...
namespace NS
{
    namespace RHI
    {
        ...
        inline RHIBufferDesc CreateIndirectArgsBufferDesc(MemorySize size)
        {
            ...
            desc.size = size;
            desc.usage =
                ERHIBufferUsage::IndirectArgs | ERHIBufferUsage::ShaderResource | ERHIBufferUsage::UnorderedAccess;
            return desc;
        }
        ...
        public:
            ...
            /// 頂点バッファビュー取得
            RHIVertexBufferView GetVertexBufferView(MemoryOffset offset = 0,
                                                    MemorySize size = 0,
        ...
        public:
            ...
            RHIBufferScopeLock(RHIBufferScopeLock&& other) noexcept
                : m_buffer(other.m_buffer), m_mapResult(other.m_mapResult), m_offset(other.m_offset),
                  m_size(other.m_size)
            {
