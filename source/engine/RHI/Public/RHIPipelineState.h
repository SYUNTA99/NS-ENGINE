...
namespace NS
{
    namespace RHI
    {
        ...
        struct RHI_API RHIInputElementDesc
        {
            ...
            {
                return {
                    "TEXCOORD", index, ERHIVertexFormat::Float2, slot, offset, ERHIInputClassification::PerVertex, 0};
            }
            ...
            {
                return {
                    "BLENDINDICES", 0, ERHIVertexFormat::UByte4, slot, offset, ERHIInputClassification::PerVertex, 0};
            }

            static RHIInputElementDesc BlendWeights(uint32 slot = 0, uint32 offset = kAppendAligned)
            {
                return {
                    "BLENDWEIGHT", 0, ERHIVertexFormat::UByte4N, slot, offset, ERHIInputClassification::PerVertex, 0};
            }
        ...
        {
        protected:
            IRHIInputLayout() : IRHIResource(ERHIResourceType::InputLayout) {}
