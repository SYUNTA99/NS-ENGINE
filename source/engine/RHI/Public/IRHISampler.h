...
namespace NS::RHI
{
    ...
    inline bool operator==(const RHISamplerDesc& a, const RHISamplerDesc& b)
    {
        return a.minFilter == b.minFilter
            ...
            && a.enableComparison == b.enableComparison
            && a.borderColor == b.borderColor
            && a.customBorderColor[0] == b.customBorderColor[0]
            ...
            && a.useCustomBorderColor == b.useCustomBorderColor
            && a.minLOD == b.minLOD
            && a.maxLOD == b.maxLOD;
    }
    ...
    public:
        ...
        /// アドレスモード設定
        RHISamplerBuilder& SetAddressMode(ERHITextureAddressMode u, ERHITextureAddressMode v, ERHITextureAddressMode w)
        {
            m_desc.addressU = u;
            m_desc.addressV = v;
            m_desc.addressW = w;
