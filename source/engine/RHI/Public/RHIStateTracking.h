...
namespace NS::RHI
{
    ...
    public:
        ...
        /// サブリソースの現在状態取得
        ERHIResourceState GetSubresourceState(IRHIResource* resource, uint32 subresource) const;
        ...
        /// 遷移要求（必要なら自動でバリア生成）
        void RequireState(IRHIResource* resource,
        ...
        /// @return 生成されたバリア数
        uint32 GetPendingBarriers(RHITransitionBarrier* outBarriers, uint32 maxBarriers);
    ...
    //=========================================================================
    // RHIGlobalResourceStateManager (16-03)
    //=========================================================================
    ...
    public:
        ...
        /// リソース登録
        void RegisterResource(IRHIResource* resource, ERHIResourceState initialState, uint32 subresourceCount = 1);
        ...
        /// サブリソースのグローバル状態取得
        ERHIResourceState GetSubresourceGlobalState(IRHIResource* resource, uint32 subresource) const;
        ...
        /// @param maxBarriers 最大バリア数
        /// @return 生成されたバリア数
        uint32 ResolveBarriers(const RHIResourceStateTracker& localTracker,
    ...
    private:
        ...
        // Hash map: resource -> GlobalResourceState（実装時にコンテナを選択）

        mutable void* m_mutex = nullptr; // スレッドセーフ用
    };

    //=========================================================================
    // RHIAutoBarrierContext (16-03)
    //=========================================================================

    /// 自動バリアコンテキスト
    /// 状態追跡付きコマンドコンテキストラッパー
    ...
    public:
        ...
        /// 初期化
        void Initialize(IRHICommandContext* context, RHIGlobalResourceStateManager* globalManager);
    ...
    //=========================================================================
    // RHIResourceStateValidator (16-03)
    //=========================================================================
    ...
    public:
        ...
        /// リソースアクセスの検証
        /// @return エラーがあればfalse
        bool ValidateAccess(IRHIResource* resource,
                            ERHIResourceState requiredState,
                            ERHIResourceState actualState,
                            uint32 subresource = kAllSubresources);

        /// 遷移の検証
        bool ValidateTransition(IRHIResource* resource,
